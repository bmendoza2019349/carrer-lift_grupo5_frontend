        ...
        <nav className="bg-gray-800 p-4">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center space-x-4">
                    <img src="https://i.postimg.cc/8cbFKHwn/img-Logo-Carrer-L.png" alt="Logo" className="w-11 h-11" />
                    ...
                    <div className="relative">
                        ...
                        {isDropdownOpen && (
                            ...
                            >
                                ...
                                <a href={"/course"} className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Ver cursos</a>
                                <a href={"/contact"} className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Contactanos</a>
                            </div>
                        )}
                    </div>
